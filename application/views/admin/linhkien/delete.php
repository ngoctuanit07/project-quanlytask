...
<div class="container">
    ...
    <div class="text-center">
        <a href="" class="btn btn-default btn-rounded btn pull-right mb-4" data-toggle="modal" data-target="#modallinhkien">Hủy linh kiện</a>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Xóa linh kiện</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button id="themlinhkien" class="btn btn-default">Hủy Linh Kiện</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#themlinhkien').click(function () {
            ...
            var url = "<?php echo base_url() . 'linhkien/xoa' ?>";
           // alert(url); return;
            var macuonlinhkien = jQuery('#macuonlinhkien').val();
            var soluong = jQuery('#soluong').val();
            var maa = jQuery('#maa').val();
            var id = parseInt(jQuery('#maid').text());
            var param = {_macuonlinhkien: macuonlinhkien, _soluong: soluong, _maa: maa,_id:id}
            $.ajax({
                url: url,
                type: "post",
                data: param,
