<?php
/**
 * Sky_Trello_OAuthSimple - A simpler version of OAuth
 *
...
class Sky_Trello_OAuthSimple {
     ...
     * @return Sky_Trello_OAuthSimple (Object)
     */
    ...
    public function setURL ($path)
    {
        if (empty($path))
        {
            throw new Sky_Trello_OAuthSimpleException('No path specified for Sky_Trello_OAuthSimple.setURL');
        }
        $this->_path=$path;
    ...
    public function setAction ($action)
    {
        ...
        {
            throw new Sky_Trello_OAuthSimpleException('Invalid action specified for Sky_Trello_OAuthSimple.setAction');
        }
        $this->_action = $action;
    ...
    public function signatures ($signatures)
    {
        ...
        {
            throw new Sky_Trello_OAuthSimpleException('Must pass dictionary array to Sky_Trello_OAuthSimple.signatures');
        }
        if (!empty($signatures))
        {
        ...
        {
            throw new Sky_Trello_OAuthSimpleException('Missing required consumer_key in Sky_Trello_OAuthSimple.signatures');
        }
        if (empty($this->_secrets['shared_secret']))
        {
            throw new Sky_Trello_OAuthSimpleException('Missing requires shared_secret in Sky_Trello_OAuthSimple.signatures');
        }
        if (!empty($this->_secrets['oauth_token']) && empty($this->_secrets['oauth_secret']))
        {
            throw new Sky_Trello_OAuthSimpleException('Missing oauth_secret for supplied oauth_token in Sky_Trello_OAuthSimple.signatures');
        }
    ...
    public function setSignatureMethod ($method="")
    {
        ...
        switch($method)
        {
            ...
            case 'HMAC-SHA1':
                ...
                break;
            default:
                throw new Sky_Trello_OAuthSimpleException ("Unknown signing method $method specified for Sky_Trello_OAuthSimple.setSignatureMethod");
                break;
        }
    ...
    */
    ...
    private static function _oauthEscape($string)
    {
        ...
        if (is_array($string)) {
            throw new Sky_Trello_OAuthSimpleException('Array passed to _oauthEscape');
        }
    ...
    private function _getApiKey()
    {
        if (empty($this->_secrets['consumer_key']))
        {
            throw new Sky_Trello_OAuthSimpleException('No consumer_key set for Sky_Trello_OAuthSimple');
        }
    ...
    private function _getAccessToken()
    {
        ...
        {
            throw new Sky_Trello_OAuthSimpleException('No access token (oauth_token) set for Sky_Trello_OAuthSimple.');
        }
    ...
    private function _generateSignature ()
    {
        ...
        switch($this->_parameters['oauth_signature_method'])
        {
            ...
            default:
                throw new Sky_Trello_OAuthSimpleException('Unknown signature method for Sky_Trello_OAuthSimple');
                break;
        }
    }
}

class Sky_Trello_OAuthSimpleException extends \Exception {
